...
// step 1 [ [ 8, 0 ], [ 8, 1 ], [ 6, 1 ], [ 5, 0 ], [ 5, 2 ], [ 4, 4 ] ]
//      [ [ 8, 0 ], ->[ 8, 1 ], [ 6, 1 ], [ 5, 0 ], [ 5, 2 ], [ 4, 4 ] ]
//      [ [ 8, 0 ], [ 8, 1 ], ->[ 6, 1 ], [ 5, 0 ], [ 5, 2 ], [ 4, 4 ] ]
//      [ [ 8, 0 ], [ 6, 1 ], [ 8, 1 ], [ 5, 0 ], [ 5, 2 ], [ 4, 4 ] ]
//      [ [ 8, 0 ], [ 6, 1 ], [ 8, 1 ], ->[ 5, 0 ], [ 5, 2 ], [ 4, 4 ] ]
//      [ [ 5, 0 ], [ 8, 0 ], [ 6, 1 ], [ 8, 1 ], [ 5, 2 ], [ 4, 4 ] ]
//      [ [ 5, 0 ], [ 8, 0 ], [ 6, 1 ], [ 8, 1 ], ->[ 5, 2 ], [ 4, 4 ] ]
//      [ [ 5, 0 ], [ 8, 0 ], [ 5, 2 ], [ 6, 1 ], [ 8, 1 ], [ 4, 4 ] ]
//      [ [ 5, 0 ], [ 8, 0 ], [ 5, 2 ], [ 6, 1 ], [ 8, 1 ], ->[ 4, 4 ] ]
//      [ [ 5, 0 ], [ 8, 0 ], [ 5, 2 ], [ 6, 1 ], [ 4, 4 ], [ 8, 1 ] ]
// step 2 [ [ 5, 0 ], [ 8, 0 ], [ 5, 2 ], [ 6, 1 ], [ 4, 4 ], [ 8, 1 ] ]
const solve = (arr) => {
  // 1 双因素排序 先按照体重倒序，在按照个数升序
  let swapTemp;
  ...
  // 2 扫描，体重从重到轻调整位置，轻的不影响重的
  let insertTemp;
  for (let i = 1; i < arr.length; i++) {
    if (arr[i][1] === i) continue;
    insertTemp = arr.splice(i, 1)[0]; // Array.prototype.splice 的返回值是数组
