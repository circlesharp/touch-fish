const { getLinkList } = require('../../utils/LinkList');
const { preTraversal, postTraversal, isPalindrome, isPalindrome2 } = require('../03-isPalindrome');
...
describe('判断回文链表', () => {
  ...
  it('判断回文链表（空间复杂度 O(1)）', () => {
    ...
    expect(isPalindrome2(ll1)).toEqual(true);
    expect(isPalindrome2(ll2)).toEqual(true);
    expect(isPalindrome2(ll3)).toEqual(false);
  });
});
